...
<script type='text/javascript'>                    
 ...
 if ( divElement.offsetWidth > 800 ) 
   { vizElement.style.width='200%';vizElement.style.height=(divElement.offsetWidth*0.90)+'px';} 
 else if ( divElement.offsetWidth > 500 ) 
   { vizElement.style.width="200%";vizElement.style.height=(divElement.offsetWidth*0.90)+'px';} 
 else { vizElement.style.width='200%';vizElement.style.minHeight='750px';vizElement.style.maxHeight=(divElement.offsetWidth*0.90)+'px';}                     
