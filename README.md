...
<script type='text/javascript'>                    
 ...
 if ( divElement.offsetWidth > 800 ) 
   { vizElement.style.width='100%';vizElement.style.height=(divElement.offsetWidth*0.95)+'px';} 
 else if ( divElement.offsetWidth > 500 ) 
   { vizElement.style.width='125%';vizElement.style.height=(divElement.offsetWidth*0.75)+'px';} 
